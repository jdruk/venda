...
public class PagamentoTela extends javax.swing.JInternalFrame {
    ...
    private final PagamentoDataTable pagamentoDataTable;
    
    public PagamentoTela(Venda venda) {
        initComponents();
        pagamentoDataTable = new PagamentoDataTable(venda);
        jtPagamentos.setModel(pagamentoDataTable);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jtPagamentos.getSelectedRow() != -1 ){
            pagamentoDataTable.pagar(jtPagamentos.getSelectedRow());
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(jtPagamentos.getSelectedRow() != -1 ){
            pagamentoDataTable.estornar(jtPagamentos.getSelectedRow());
        }
