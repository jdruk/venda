...
public class ClienteTelaPrincipal extends javax.swing.JInternalFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jtClientes.getSelectedRow() != -1) {
            clienteDataTable.excluirLinha(jtClientes.getSelectedRow());
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jtClientes.getSelectedRow() != -1) {
            ClienteTela telaAlterar = new ClienteTela(clienteDataTable.pegarCliente(jtClientes.getSelectedRow()), clienteDataTable);
            this.getDesktopPane().add(telaAlterar);
